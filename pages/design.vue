  ...
  <div class="page">
    <div class="content">
        ...
        <pw-section class="orange" label="Select-spec">
          <ul>
            <li>
              ...
              <div>
                <select type="text" id="selectSpec" v-model="selectedSpec">
                  <option
                    v-for="spec in specs"
      ...
      <aside v-if="activeSidebar" class="sticky-inner inner-right">
        <section>
          <tabs>
            <tab :id="'responses'" :icon="'watch_later'" :label="$t('responses')" :selected="true">
              <responses ref="responseComponent" />
            </tab>
...
export default {
  ...
  components: {
    ...
    responses: () => import("../components/layout/responses"),
  ...
  methods: {
    ...
    async sendRequest() {
      ...
      if (!this.selectedSpec) {
        this.$toast.error(this.$t("url_invalid_spec"), {
          icon: "error",
        })
        return
      }
      ...
      let request = {
        uri: this.uri || this.url + this.path,
        url: this.url,
        path: this.path,
        method: this.method,
        auth: this.auth,
      ...
      this.$store.commit("design/addRequest", { specid: this.selectedSpec, request: request })
