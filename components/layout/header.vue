  ...
  <header class="header">
    <div class="flex-wrap">
      ...
      <span>
        ...
        <nuxt-link to="/integration/gitlab">
          <button class="icon" aria-label="Gitlab" v-tooltip="'Gitlab'">
            <svg width="36" height="36" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 586 559">
              <path
